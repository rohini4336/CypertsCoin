...
// CypertsCoin: total coins staked (non-spendable until maturity)
...
// CypertsCoin: check 'spent' consistency between wallet and txindex
// CypertsCoin: fix wallet spent state according to txindex
...
// CypertsCoin: disable transaction (only for coinstake)
