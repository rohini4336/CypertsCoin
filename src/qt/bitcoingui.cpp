...
#ifdef Q_OS_MAC
    resize(1040, 610);
    setWindowTitle(tr("CypertsCoin Core wallet - Mac"));
#elif _WIN32
    resize(945, 600);
    setWindowTitle(tr("CypertsCoin Core wallet - Windows"));
#else
    resize(1110, 650);
    setWindowTitle(tr("CypertsCoin Core wallet - Linux"));
#endif
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a CypertsCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About CypertsCoin"), this);
    aboutAction->setToolTip(tr("Show information about CypertsCoin"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for CypertsCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("CypertsCoin core - ") + ("client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("CypertsCoin Core - client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CypertsCoin network", "", count));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid CypertsCoin address or malformed URI parameters."));
    }
