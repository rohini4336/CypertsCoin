...
static const int64_t MIN_TX_FEE = 0.00001000;
...
static const int64_t POS_STAKE_REWARD = 1.2 * COIN;//120% annual interest(10% per month)
/*
...
#define FOUNDATION "BJohXRYTtibAsHB7EuF25Yz6D5GdJ3k9Nr"
//#define FOUNDATION2 ""
#define FOUNDATION_TEST "BJohXRYTtibAsHB7EuF25Yz6D5GdJ3k9Nr"
...
public:
    ...
    {
        // CypertsCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // CypertsCoin: get transaction coin age
...
public:
    ...
    // CypertsCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // CypertsCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // CypertsCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // CypertsCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // CypertsCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // CypertsCoin: block index flags
    enum  
    {
