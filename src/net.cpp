...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("CypertsCoin-ext-ip");
...
void ThreadTorNet(void* parg)
{
    ...
    RenameThread("CypertsCoin-tornet");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CypertsCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
{
   /* {"134.209.219.115","134.209.219.115"},
    {"68.183.10.153","68.183.10.153"},
    {"165.22.108.128","165.22.108.128"},
    {"134.209.186.131","134.209.186.131"},
    {"165.22.232.90","165.22.232.90"}*/
};
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("CypertsCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("CypertsCoin-adrdump");
...
{
    // Make this thread recognisable as the connection opening thread
    RenameThread("CypertsCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("CypertsCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CypertsCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("CypertsCoin-start");
