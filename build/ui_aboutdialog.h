...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About CypertsCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>CypertsCoin</b> version", 0));
        copyrightLabel->setText(QApplication::translate("AboutDialog", "<html><head/><body><p>Copyright \302\251 2017 <a href=\"http://CypertsCoin.org\"><span style=\" text-decoration: underline; color:#00007f;\">The CypertsCoin developers</span></a></p></body></html>", 0));
        label_3->setText(QApplication::translate("AboutDialog", "Copyright @ The Bitcoin Developers", 0));
